...
const VerifikasiPage = () => {
  ...
  return (
    <div>
      <Navbar title="Proses Verifikasi Akun Berhasil" showBack={false} />
      <div className="border-b-8 border-b-slate-100 p-5">
        <h2 className="font-semibold text-slate-500">Verifikasi Akun Telah Berhasil,</h2>
        <p className="mt-5 text-slate-500">
          Nikmati kemudahan akses membantu dan dibantu oleh sesama lewat Zis Indosat
        </p>
      </div>
