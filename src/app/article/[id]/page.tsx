...
import useQueryDetailArticle from '../hooks/useQueryDetailAricle';
            ...
            <DataLayout isLoading={isLoading} isError={isError} className="h-[80dvh]">
                ...
                <div className="mt-5">
                    <div className="mb-4 flex items-center justify-between px-4">
                        <h3 className="font-semibold">Baca Kabar Berita Lainnya</h3>
                    </div>
                    <ArticleCarousel />
                </div>
                ...
                {isSharedVisible &&
                    <div
                        className="justify-center items-end flex fixed inset-0 backdrop-blur-sm z-50 outline-none focus:outline-none"
                    >
